const useStyles = () => {
    return {
        ...
        edit: "cursor-pointer transition-colors md:max-3xl:invisible md:max-3xl:group-hover:visible hover:stroke-gray-700 active:stroke-gray-800",
        delete: "cursor-pointer transition-colors md:max-3xl:invisible md:max-3xl:group-hover:visible hover:stroke-red-400 active:stroke-red-500",
