const useStyles = () => {
    return {
        mainContainer: "w-full f-full flex flex-col px-5 sm:px-15 my-5 mx-3 md:px-10 md:py-8 md:mx-5 xl:mx-5 xl:my-3 lg:py-5 lg:px-10 xl:py-5 xl:px-10 justify-center lg:my-5 lg:mr-5 2xl:pl-15",
