const useStyles = () => {
    return {
        mainContainer: "flex h-3/4 lg:h-full lg:w-3/4 xl:w-4/5 flex-col box-border px-3 sm:px-5 sm:px-15 md:px-10 md:py-8 lg:py-5 lg:px-5 xl:py-5 xl:px-10 justify-center 2xl:pl-15",
