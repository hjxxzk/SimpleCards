const useStyles = () => {
    return {
        sidebar: "bg-gray-100 py-5 pb-20 px-15 md:px-40 lg:px-5 xl:px-10 lg:w-1/5 3xl:w-1/6 overflow-hidden absolute w-screen lg:static h-screen flex flex-col z-1000",
