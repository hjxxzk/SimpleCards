const useStyles = () => {
    return {
        sidebar: "bg-gray-100 py-5 pb-20 px-15 md:px-40 lg:px-5 lg:pr-10 w-full overflow-hidden absolute w-screen lg:static lg:w-100 xl:w-90 2xl:w-110 h-screen flex flex-col",
