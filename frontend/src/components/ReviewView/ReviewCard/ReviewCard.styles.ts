const useStyles = () => {
    return {
        card: "relative w-1/3 h-1/2 bg-neutral-50 rounded-lg flex justify-center items-center text-4xl cursor-pointer [perspective:1000px]",
        innerCard: "relative w-full h-full transition-transform duration-500 [transform-style:preserve-3d]",
        front: "absolute inset-0 bg-neutral-50 border-1 border-neutral-200 shadow-xl flex items-center justify-center rounded-lg",
        ...
        text: "text-4xl",
        buttonsContainer: "absolute bottom-15 w-full h-1/11 flex justify-between px-15 text-lg text-black font-semibold",
